...
def crop(images, target, region):
    '''
        function to crop the image and transform the annotation
    '''
...
def hflip(images, target):
    '''
        function to horizontal flip the image and transform the annotation
    '''
...
def resize(images, target, size, max_size=None):
    ...
    def get_size_with_aspect_ratio(image_size, size, max_size=None):
        '''
            A function that calculates the size of the resized image while preserving its aspect ratio.
        '''
        w, h = image_size
    ...
    # transform the annoation into resized size
...
class RandomCrop(object):
    '''
        tranform input by random crop from the input frame
    '''
...
class RandomSizeCrop(object):
    '''
        tranform input by crop random size from the input frame
    '''
...
class RandomSizeCrop_Custom(object):
    '''
        tranform input by random crop the input frame, 
        this class crop the image into based on size of image
    '''
    def __init__(self, size):
        self.size = size
...
class Resize_Custom(object):
    '''
        tranform input by resize the input frame, 
        this class resize the image into given resolution
    '''
    def __init__(self, size):
        self.size = size
...
class CenterCrop(object):
    '''
        tranform input by crop the input frame from centre
    '''
    def __init__(self, size):
        self.size = size
...
class RandomHorizontalFlip(object):
    '''
        tranform input by random horizontal flip the input frame
    '''
...
class HorizontalFlip(object):
    '''
        tranform input by horizontal flip the input frame
    '''
    def __call__(self, imgs, target):
        return hflip(imgs, target)
...
class RandomResize(object):
    '''
        tranform input by random resize the input frame
    '''
...
class RandomPad(object):
    '''
        tranform input by random pad the input frame
    '''
...
class RandomErasing(object):
    '''
        Transform by randomly erase rectangular regions from input images for data augmentation
    '''
...
class Normalize(object):
    '''
        normalize the image and target(boundding box)
    '''
...
class NormalizeRoI(object):
    '''
        normalize the image and not normailize annotation
    '''
    def __init__(self, mean, std):
        self.mean = mean
        self.std = std
...
class ColorJitter(object):
    '''
         Transform the input frame by:
         randomly adjusts the brightness, contrast, and saturation of the input image, 
         as well as adding a random hue offset.
    '''
...
class Compose(object):
    '''
        compose the input transform function
    '''

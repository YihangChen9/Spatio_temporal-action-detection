...
class Backbone(nn.Module):
    ...
    def __init__(self, train_backbone: bool, num_channels: int, position_embedding, cfg):
        ...
        # whether update the weight of backbone
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # store the origin image tensor, used for temporal context
        ...
        # return feature, position embedding and origiin image tensor to further calculate
...
def build_backbone(cfg):
    '''
        used for build backbone also add position embedding.
    '''

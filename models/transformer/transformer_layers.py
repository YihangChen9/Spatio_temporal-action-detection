...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,
                     ...
                     pos: Optional[Tensor] = None):
        '''
            normalization after self_attention
        '''
        # use two self_attention layer to embedding the temporal and spatial information
    ...
    def forward_pre(self, src,
                    ...
                    pos: Optional[Tensor] = None):
        '''
            normalization before self_attention
        '''
        src2 = self.norm1(src)

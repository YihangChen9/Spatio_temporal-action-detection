...
def parse_id():
    '''
        get categoties of JHMDB dataset
    '''
    ...
    def load_detection_from_path(self, file_lst):
        ...
        for path in file_lst:
            ...
            for line in data:
                ...
                # if all classification score less than the confidence, ignore this tubelet
                ...
                # save the bounding box, label and score with highest classification score
                x = np.argmax(scores)
                sample_dict_per_image[image_key]['bbox'].append(

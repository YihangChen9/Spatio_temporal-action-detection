...
def read_labelmap(labelmap_file):
    """Read label map and class ids of AVA dataset."""
...
def build_log_dir(cfg):
    '''
        create the log directory to store model parameter, evalution result,
        tensorboard file and training configuration
    '''
